  ...
  return (
    <main className="min-h-screen flex items-center justify-center flex-col relative overflow-hidden">
      ...
      <div className="text-center animate-flip-down animate-once animate-ease-out animate-delay-200 z-5">
        <h1 className="font-code text-7xl font-semibold tracking-tighter text-shadow-lg ">Welcome to Planex</h1>
        <h2 className="font-code text-2xl tracking-wide text-shadow-md ">Plan your own projects!</h2>
      </div>
        <Link className="font-code font-bold text-1xl" href="/panel">
